...
return {
    ...
    ["Triblade"] = "三尖两刃刀",
	[":Triblade"] = "装备牌·武器<br /><b>攻击范围</b>：3<br /><b>武器技能</b>：每当你使用【杀】对目标角色造成伤害后，你可以弃置一张手牌并选择目标角色距离为1的一名其他角色，对其造成1点伤害。",
	["tribladeskill"] = "三尖两刃刀",
	...
	["drowning"] = "水淹七军",
	[":drowning"] = "锦囊牌<br /><b>时机</b>：出牌阶段<br /><b>目标</b>：所有其他角色<br /><b>效果</b>：作用效果：目标角色选择一项：1.弃置装备区里的所有牌（至少一张）；2.弃置等于体力值的手牌；3.受到你造成的1点雷电伤害。",
	["drowning:throw"] = "弃置装备区里的所有牌",
	["drowning:damage"] = "弃置 %arg 张手牌或受到使用者造成的1点雷电伤害",
