...
return {
	...
	["longwei"] = "龙卫",
	[":longwei"] = "当你攻击范围内的一名其他角色需要于回合外使用或打出基本牌时，可以令你选择是否打出相应的基本牌（视为由该角色使用或打出）。当你以此法打出基本牌后，可以弃置当前回合角色的一张牌。",
	["longwei_VS"] = "龙卫",
	["@longwei-card"] = "请打出一张相应基本牌响应 %src “龙卫”",
	["longwei_dis:discard"] = "你可以弃置当前回合角色的一张牌",
	--[["yajiao"] = "涯角",
	[":yajiao"] = "每当你于回合外使用或打出基本牌时，你可以展示牌堆顶的一张牌：若此牌为基本牌，你可以获得之，否则你可以将之置入弃牌堆。",
	["yajiao:draw"] = "获得之",
	["yajiao:throw"] = "置入弃牌堆",]]
	["longhun"] = "龙魂",
	[":longhun"] = "你的回合外，若你的体力值不大于X，你可以将一张牌按以下规则使用或打出：X = 4 ，方块当火【杀】；X = 3，红桃当【桃】；X = 2，梅花当【闪】；X = 1，黑桃当【无懈可击】。",
	--[":longhun"] = "每当你于回合外使用或打出基本牌时，你可以展示牌堆顶的一张牌：若此牌为基本牌，你可以获得之，否则你可以将之置入弃牌堆。",
	...
	["tieji"] = "铁骑",
	[":tieji"] = "每当你指定【杀】的目标后，你可以摸一张牌：若如此做，你弃一张牌，然后该角色须弃置一张与你弃置的牌颜色相同的牌，否则其不能使用【闪】响应此【杀】且该角色的非锁定技无效直到回合结束。",
	...
	["qicai"] = "奇才",
	[":qicai"] = "当你使用锦囊牌时，你可以摸一张牌，然后将一张牌暗置于一名其他角色的武将牌旁。当场上存活人数不多于4时，取消描述中的“其他”二字。",
	["qicai-invoke"] = "请选择一名角色扣置手牌",
	["QicaiGive"] = "请在其武将牌旁扣置一张手牌",
	["cangji"] = "藏机",
	[":cangji"] = "当你除坐骑牌外装备牌于回合外被弃置时，你可以防止之；当你死亡时，你可以将至少一张装备区内的牌以任意方式分配给其他角色。",
	...
	["@zhue-slash"] = "你可以发动“诛恶”对 %dest 使用一张【杀】",
	...
	["sunquan"] = "孙权",
	["zhiheng"] = "制衡",
	[":zhiheng"] = "阶段技。你可以弃置一至X张牌（X为存活角色数）：若如此做，你摸等量的牌。",
	["zuoli"] = "佐立",
	...
	["liuli"] = "流离",
	[":liuli"] = "每当你成为【杀】的目标时，你可以交给此【杀】使用者一张牌并选择你攻击范围内为此【杀】合法目标（无距离限制）的一名角色：若如此做，使用者选择一项：取消你为此【杀】目标，或弃一张牌令该角色代替你成为此【杀】的目标。",
	["~liuli"] = "选择一张牌→选择一名其他角色→点击确定",
	["@liuli"] = "%src 对你使用【杀】，你可以交给 %src 一张牌发动“流离”",
	["@liuli-dis"] = "请选择是否弃置 1 张牌（包括装备区的牌），改为对 %dest 使用一张【杀】",
	...
	["liyu"] = "利驭",
	[":liyu"] = "每当你使用【杀】对一名其他角色造成伤害后，该角色可以令你获得其一张牌：若如此做，该角色可以令你视为对其选择的体力值多于其的另一名角色使用【决斗】。",
