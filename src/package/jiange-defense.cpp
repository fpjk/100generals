    ...
    : Package("JianGeDefense")
{
    ...
    jg_soul_zhugeliang->addSkill(new Kuangfeng);
    jg_soul_zhugeliang->addSkill(new Dawu);
    jg_soul_zhugeliang->addSkill(new QixingClear);
    jg_soul_zhugeliang->addSkill("qimen");
    related_skills.insertMulti("jgbiantian", "#qixing-clear");
    related_skills.insertMulti("jgbiantian", "#kuangfeng");
    related_skills.insertMulti("jgbiantian", "#dawu");
    ...
    jg_machine_lingjiaxuanwu->addSkill(new Yizhong);
