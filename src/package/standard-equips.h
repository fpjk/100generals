...
class VsCrossbow : public Weapon
{
    Q_OBJECT
...
public:
    Q_INVOKABLE EightDiagram(Card::Suit suit = Club, int number = 2);
};
...
public:
    Q_INVOKABLE WoodenOx(Card::Suit suit = Spade, int number = 2);
...
class CROSSBOWPackage : public Package
{
    Q_OBJECT
