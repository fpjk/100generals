...
class BossJuece : public TriggerSkill
{
public:
    BossJuece() : TriggerSkill("bossjuece")
    {
        events << CardsMoveOneTime;
    }
    ...
    : Package("BossMode")
{
    ...
    mamian->addSkill("fankui");
    mamian->addSkill(new BossLianyu);
    mamian->addSkill(new BossJuece);
    ...
    luocha->addSkill(new Kuanggu);
    luocha->addSkill(new KuangguRecord);
