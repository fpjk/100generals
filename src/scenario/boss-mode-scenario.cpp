...
class BossJishi : public PhaseChangeSkill
{
public:
    BossJishi() :PhaseChangeSkill("bossjishi")
    {
        frequency = Compulsory;
    }
...
public:
        ...
        :ScenarioRule(scenario)
    {
        ...
        boss_banlist << "yuanshao" << "yanliangwenchou" << "zhaoyun" << "guanyu";

        boss_skillbanned << "luanji" << "shuangxiong" << "longdan" << "wusheng";

        dummy_skills << "xinsheng" << "zhiba";

        available_wake_skills << "hunshang" << "zhiji";
    }
        ...
        case GameStart:{
            if (player == NULL) {
                ...
                if ((qrand() % 2) == 1) {
                    ...
                    room->acquireSkill(player, "bossjishi");
