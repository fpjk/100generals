...
QStringList RoomThread3v3::getGeneralsWithoutExtension() const
{
    ...
    list_name << "nos_caocao" << "nos_simayi" << "vs_xiahoudun" << "zhangliao" << "guojia" << "zhenji"
        << "liubei" << "vs_guanyu" << "nos_zhangfei" << "vs_zhaoyun" << "zhugeliang" << "nos_machao" << "vs_huangyueying"
        << "sunquan" << "nos_ganning" << "nos_huanggai" << "nos_zhouyu" << "vs_daqiao" << "sunshangxiang"
        << "vs_huatuo" << "vs_lvbu" << "diaochan"
        << "vs_xiahouyuan" << "vs_xiaoqiao"
        << "pangde"
        << "nos_sunjian" << "vs_xuhuang" << "jiaxu"
        << "sunce" << "jiangwei"
        << "zhugejin" << "wenpin";
