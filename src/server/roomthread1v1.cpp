...
void RoomThread1v1::run()
{
    ...
    if (!Config.value("1v1/UsingExtension", false).toBool()) {
        ...
        candidates << "nos_caocao" << "nos_simayi" << "kof_xiahoudun" << "kof_zhangliao" << "kof_xuchu" << "nos_guojia" << "kof_zhenji"
            << "kof_guanyu" << "nos_zhangfei" << "zhugeliang" << "kof_zhaoyun" << "nos_machao" << "kof_huangyueying"
            << "sunquan" << "nos_ganning" << "nos_huanggai" << "nos_zhouyu" << "kof_luxun" << "kof_sunshangxiang"
            << "kof_lvbu" << "kof_diaochan"
            << "kof_xiahouyuan" << "kof_huangzhong" << "kof_caoren"
            << "kof_dianwei" << "yanliangwenchou"
            << "kof_menghuo" << "kof_zhurong" << "nos_sunjian" 
            << "kof_jiangwei"              
            << "hejin";
        if (rule == "2013") {
            candidates << "kof_liubei" << "kof_weiyan" << "kof_lvmeng" << "kof_daqiao"
                << "kof_zhoutai" << "huatuo" << "pangde"
                << "niujin" << "hansui";
        }
        qShuffle(candidates);
