...
QWidget *ServerDialog::createMiscTab()
{
    ...
    crossbow_checkbox = new QCheckBox(tr("Use VsCrossbow"));
    crossbow_checkbox->setChecked(Config.UseVsCrossbow);
    ...
    tablayout->addWidget(crossbow_checkbox);
...
int ServerDialog::config()
{
    ...
    Config.UseVsCrossbow = crossbow_checkbox->isChecked();
    ...
    Config.setValue("UseVsCrossbow", Config.UseVsCrossbow);
