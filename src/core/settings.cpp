...
void Settings::init()
{
    ...
    UseVsCrossbow = value("UseVsCrossbow", false).toBool();
    ...
    NeverNullifyMyTrick = value("NeverNullifyMyTrick", false).toBool();
    ...
    if (forbid_packages.isEmpty()) {
        forbid_packages << "New3v3Card" << "New1v1Card" << "BossMode" << "JianGeDefense" << "NostalStandard" << "Special3v3" << "Special1v1"
            << "Special3v3Ext" << "Special1v1Ext" << "CROSSBOW";
